...
class Invoice(models.Model):
    ...
    senderAddress = models.ForeignKey(
        Address, on_delete=models.CASCADE, related_name='sender_invoices')
    clientAddress = models.ForeignKey(
        Address, on_delete=models.CASCADE, related_name='client_invoices')
